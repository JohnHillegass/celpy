...
/* package _/Users/johnhillegass/Desktop/py-cel/interpreter */
...
extern long long int Slice_Ptr_interpreter_AttributePattern_CTor();

extern GoInt Slice_Ptr_interpreter_AttributePattern_len(long long int p0);

extern long long int Slice_Ptr_interpreter_AttributePattern_elem(long long int p0, GoInt p1);

extern void Slice_Ptr_interpreter_AttributePattern_set(long long int p0, GoInt p1, long long int p2);

extern void Slice_Ptr_interpreter_AttributePattern_append(long long int p0, long long int p1);
...
extern long long int interpreter_Dispatcher_OverloadIds(long long int p0);

extern long long int interpreter_EvalState_IDs(long long int p0);

extern void interpreter_EvalState_Reset(long long int p0, char p1);

extern void interpreter_EvalState_SetValue(long long int p0, long long int p1, long long int p2, char p3);

extern long long int interpreter_Interpretable_Eval(long long int p0, long long int p1);

extern long long int interpreter_Interpretable_ID(long long int p0);

extern long long int interpreter_NamespacedAttribute_AddQualifier(long long int p0, long long int p1);

extern long long int interpreter_NamespacedAttribute_CandidateVariableNames(long long int p0);

extern char interpreter_NamespacedAttribute_HasQualifiers(long long int p0);

extern long long int interpreter_NamespacedAttribute_ID(long long int p0);

extern long long int interpreter_PartialActivation_Parent(long long int p0);

extern long long int interpreter_PartialActivation_UnknownAttributePatterns(long long int p0);

extern long long int interpreter_Qualifier_ID(long long int p0);

extern long long int interpreter_AttributeFactory_ConditionalAttribute(long long int p0, long long int p1, long long int p2, long long int p3, long long int p4);

extern long long int interpreter_AttributeFactory_MaybeAttribute(long long int p0, long long int p1, char* p2);

extern long long int interpreter_AttributeFactory_NewQualifier(long long int p0, long long int p1, long long int p2, char* p3);

extern long long int interpreter_AttributeFactory_RelativeAttribute(long long int p0, long long int p1, long long int p2);

extern long long int interpreter_Attribute_AddQualifier(long long int p0, long long int p1);

extern long long int interpreter_Attribute_ID(long long int p0);

extern long long int interpreter_Activation_Parent(long long int p0);

// --- wrapping struct: interpreter.AttributePattern ---

extern long long int interpreter_AttributePattern_CTor();

extern long long int interpreter_AttributePattern_QualString(long long int p0, char* p1);

extern long long int interpreter_AttributePattern_QualInt(long long int p0, long long int p1);

extern long long int interpreter_AttributePattern_QualUint(long long int p0, long long unsigned int p1);

extern long long int interpreter_AttributePattern_QualBool(long long int p0, char p1);

extern long long int interpreter_AttributePattern_Wildcard(long long int p0);

extern char interpreter_AttributePattern_VariableMatches(long long int p0, char* p1);

extern long long int interpreter_AttributePattern_QualifierPatterns(long long int p0);

// --- wrapping struct: interpreter.AttributeQualifierPattern ---

extern long long int interpreter_AttributeQualifierPattern_CTor();

extern char interpreter_AttributeQualifierPattern_Matches(long long int p0, long long int p1);

extern long long int interpreter_NewAttributePattern(char* p0);

extern long long int interpreter_NewDispatcher();

extern long long int interpreter_NewInterpreter(long long int p0, long long int p1, long long int p2, long long int p3, long long int p4);

extern long long int interpreter_NewPartialAttributeFactory(long long int p0, long long int p1, long long int p2);

extern long long int interpreter_PruneAst(long long int p0, long long int p1);

extern long long int interpreter_EmptyActivation();

extern long long int interpreter_NewAttributeFactory(long long int p0, long long int p1, long long int p2);

extern long long int interpreter_NewEvalState();

extern long long int interpreter_NewHierarchicalActivation(long long int p0, long long int p1);

extern long long int interpreter_NewStandardInterpreter(long long int p0, long long int p1, long long int p2, long long int p3);

extern long long int interpreter_ExtendDispatcher(long long int p0);

extern long long int interpreter_NewActivation(char* p0);
